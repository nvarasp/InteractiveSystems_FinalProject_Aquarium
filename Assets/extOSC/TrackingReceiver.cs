...
public class TrackingReceiver : MonoBehaviour
{
    ...
    void StartPose() {
        ...
        pose.Add("rightWrist", new Vector3(100, 0, 0));
        pose.Add("leftWrist", new Vector3(-100, 0, 0));
        pose.Add("rightKnee", new Vector3(100, -250, 0));
        pose.Add("leftKnee", new Vector3(-100, -250, 0));
        pose.Add("rightHip", new Vector3(100, 0, 0));
        pose.Add("leftHip", new Vector3(-100, 0, 0));
    ...
    void Update()
    {
        ...
        rightHip.transform.position = pose["rightHip"];
        leftHip.transform.position = pose["leftHip"];
    }
